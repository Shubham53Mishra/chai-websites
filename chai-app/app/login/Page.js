     ...
     py-14 container mx-auto">
      ...
      <div className="social-login-buttons">
        <div class="flex flex-col gap-2 min-h-screen  p-10   items-center">
          ...
          <button className="flex items-center
           border bg-slate-50 text-black border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            <svg
              className="h-6 w-6 mr-2"
              xmlns="http://www.w3.org/2000/svg"
              xmlns:Xlink="http://www.w3.org/1999/xlink"
